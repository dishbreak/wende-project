...
%            greenCh = 2*obj.MTFrame(:,:,2)-obj.MTFrame(:,:,1)-obj.MTFrame(:,:,3);
            ...
            detectionPlane = im2bw(greenCh,0.02);
        ...
        function SendImage(obj)
            ...
            obj.Network.setImage(now, 3, 300, 180,sendFrame);
            obj.Network.sendImage;
        end
        function SendSysStatus(obj)
            obj.Network.setStatus(now, obj.Network.getSystemStatus , obj.LaserStatus, 'Never tell me the odds!');
