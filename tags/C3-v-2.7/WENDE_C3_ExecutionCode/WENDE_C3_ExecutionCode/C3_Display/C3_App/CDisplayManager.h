...
public: 
    ...
    int Update_Laser_PPI_Position(CoordinatePair^ inputCoords, bool HasLaserPoint);
    int Update_Laser_Location(CoordinatePair^ LaserLocation, bool HasLaserLocation);
    int Update_Pip_PPI_Position(array<CoordinatePair^>^ PipCoordinateUpdate, int NumValidPips);
	...
	void Set_Notification_Alert(int nNotificationAlert);
	...
	int Get_Notification_Alert(void);
